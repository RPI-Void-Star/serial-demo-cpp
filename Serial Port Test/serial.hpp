...
public:
    ...
    minicom_client(boost::asio::io_service& io_service, unsigned int baud, const string& device, ostream *output)
    : active_(true),
...
private:
    ...
    { // the asynchronous read operation has now completed or failed and returned an error
        ...
        { // read completed, so process the data
            outputStream->write(read_msg_, bytes_transferred); // echo to standard output
